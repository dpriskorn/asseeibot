...
def print_all_matches_table(wikipedia_page: WikipediaPage):
    ...
    matches_lists: List[List[FuzzyMatch]] = \
        [doi.crossref.work.named_entity_recognition.subject_matches for doi in wikipedia_page.dois
         if doi.crossref.work is not None and doi.crossref.work.named_entity_recognition is not None]
