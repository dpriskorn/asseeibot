...
import config
from asseeibot.helpers.argparse_setup import setup_argparse_and_return_args, ArgumentParser
...
def delete_match(args: ArgumentParser):
    qid = EntityId(raw_identifier=str(args.delete_match))
...
def main() -> None:
    ...
    # print("Running main")
    args: ArgumentParser = setup_argparse_and_return_args()
